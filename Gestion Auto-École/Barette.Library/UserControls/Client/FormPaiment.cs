...
namespace Barette.Library.UserControls.Client {
	...
	public class FormPaiment : System.Windows.Forms.Form {
		...
		private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e) {
			...
			e.Graphics.DrawString("Imprimé le : " + DateTime.Now.ToShortDateString(), new Font("Times New Roman", 12, FontStyle.Regular), Brushes.Black, leftMargin + 450, yPos, new StringFormat());
			...
			e.Graphics.DrawString("Numéro de contrat: " + this._Client.ContratNumber, printFont, Brushes.Black, leftMargin + 20, yPos, new StringFormat());
			...
			e.Graphics.DrawString("Numéro de reçu", new Font("Times New Roman", 12, FontStyle.Bold), Brushes.Black, leftMargin + 200, yPos, new StringFormat());
