...
namespace Barette.IDE.Forms.LigueSecuriter
{
    ...
    public class FormLigueSecuriter : Form
    {
        ...
        private RadioButton cbFindSpyder;
        ...
        private void InitializeComponent()
        {
            ...
            this.cbFindSpyder = new System.Windows.Forms.RadioButton();
            ...
            // groupBox1
            // 
            this.groupBox1.Controls.Add(this.cbFindSpyder);
            ...
            // cbFindSpyder
            // 
            this.cbFindSpyder.AutoSize = true;
            this.cbFindSpyder.Location = new System.Drawing.Point(48, 106);
            this.cbFindSpyder.Name = "cbFindSpyder";
            this.cbFindSpyder.Size = new System.Drawing.Size(58, 17);
            this.cbFindSpyder.TabIndex = 4;
            this.cbFindSpyder.Text = "Spyder";
            this.cbFindSpyder.UseVisualStyleBackColor = true;
            this.cbFindSpyder.Click += new System.EventHandler(this.rbFindSpyder_Click);
            // 
            // cbfindCyclomoteur
            // 
            ...
            this.cbFindAll.Location = new System.Drawing.Point(48, 129);
            ...
            customer2.BVA = false;
            customer2.BVADate = new System.DateTime(2005, 2, 20, 21, 27, 11, 328);
            customer2.City = "";
            customer2.ClientNull = false;
            customer2.CodePostal = "   -";
            customer2.ContratNumber = "0";
            customer2.DateAttestation1 = new System.DateTime(2010, 5, 27, 12, 38, 39, 217);
            customer2.DateAttestation2 = new System.DateTime(2010, 5, 27, 12, 38, 39, 217);
            customer2.DateDebutCours = new System.DateTime(2010, 3, 11, 8, 31, 48, 196);
            customer2.DateExpiration = new System.DateTime(2010, 3, 11, 8, 31, 48, 196);
            customer2.DateInscription = new System.DateTime(2003, 8, 26, 0, 0, 0, 0);
            customer2.DateNaissance = new System.DateTime(2010, 3, 11, 8, 31, 48, 196);
            customer2.DateTemporaire = new System.DateTime(2005, 2, 20, 21, 27, 11, 328);
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
            ...
            customer2.Phone = "(418)418-418";
            customer2.PhoneBureau = "(418)418-418";
        ...
        private void Find()
        {
            ...
            else if (cbFindSpyder.Checked == true)
            {
                //Recherche les motos
                RapportType = TypeRapport.Spyder;
                FindLigue(VehiculeType.Spyder);
            }
        ...
        private void rbFindSpyder_Click(object sender, EventArgs e)
        {
            if (cbAutoFind.Checked == true)
                Find();
        }
