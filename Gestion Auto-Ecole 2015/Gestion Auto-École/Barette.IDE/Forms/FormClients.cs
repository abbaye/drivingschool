...
namespace Barette.IDE.Forms
{
    ...
    public class FormClients : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.Windows.Forms.ListViewGroup listViewGroup6 = new System.Windows.Forms.ListViewGroup("Véhicule : Spyder", System.Windows.Forms.HorizontalAlignment.Left);
            ...
            listViewGroup6.Header = "Véhicule : Spyder";
            listViewGroup6.Name = "Spyder";
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
                    ...
                    else
                    {
                        ...
                        switch (clientControl1.TypeVehicule)
                        {
                            ...
                            case VehiculeType.Cyclomoteur:
                                ...
                                if (clientControl1.Client.IsSpyder)
                                    lvClient.Groups[5].Items.Add(lvClient.SelectedItems[0]);
                                else
        ...
        /// </summary>
        public void AddClient(Customer Client) => _ClientList.Add(Client);
            ...
            else
            {
                switch (client.TypeVehicule)
                {
                    ...
                    case VehiculeType.Cyclomoteur:
                        ...
                        if (client.IsSpyder)
                            lvClient.Groups[5].Items.Add(itm);
                        else
