...
namespace Barette.Library
{
    public static class DateTimeFunc {		
        ...
        /// <returns></returns>
        public static DateTime HoursFromString(string hours) => DateTime.Parse(hours.ToUpper().Replace("H", ":"));
        ...
        public static bool HoursIsBetween(DateTime HeureBasse, DateTime HeureEntre, DateTime HeureHaute) => HeureBasse.TimeOfDay <= HeureEntre.TimeOfDay &&
