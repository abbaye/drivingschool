...
namespace Crownwood.Magic.Menus
{
    ...
    public class MenuControl : ContainerControl, IMessageFilter
    {
		...
		protected GlyphFading _glyphFading;
            ...
            set
            {
                ...
                switch(value)
                {
                    ...
                    case DockStyle.Right:
                        this.Width = 0;
                        _direction = DirectionUL.Vertical;
                        break;
                }
		...
		[Category("Appearance")]
		[DefaultValue(GlyphFading.Default)]
		public GlyphFading GlyphFading
		{
			get { return _glyphFading; }
			set { _glyphFading = value; }
		}
        ...
        protected void DefineHighlightBackColors(Color baseColor)
        {
            ...
            if (_defaultHighlightBackColor)
            {
                ...
                _highlightBackLight = ColorHelper.CalculateColor(_highlightBackDark, Color.White, 70);
            }
            else
            {
                        ...
                        switch(_style)
                        {
                            case VisualStyle.IDE:
                                if (_selected)
                                {
									...
									if (_drawUpwards && (_direction == DirectionUL.Horizontal))
									{
