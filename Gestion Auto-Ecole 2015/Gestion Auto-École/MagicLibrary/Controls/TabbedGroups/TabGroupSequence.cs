...
namespace Crownwood.Magic.Controls
{
    public class TabGroupSequence : TabGroupBase, IResizeSource
	{
            ...
            : base(tabbedGroups)
        {
            ...
            InternalConstruct(tabbedGroups, DirectionUL.Horizontal);
        }
    
        public TabGroupSequence(TabbedGroups tabbedGroups, TabGroupBase parent)
            : base(tabbedGroups, parent)
        {
		    InternalConstruct(null, DirectionUL.Horizontal);
        }

        public TabGroupSequence(TabbedGroups tabbedGroups, TabGroupBase parent, DirectionUL direction)
            : base(tabbedGroups, parent)
        {
            InternalConstruct(null, direction);
        }

        protected void InternalConstruct(Control control, DirectionUL direction)
        {
