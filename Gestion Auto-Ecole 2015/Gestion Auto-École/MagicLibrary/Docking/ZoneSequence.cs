...
namespace Crownwood.Magic.Docking
{
    ...
    public class ZoneSequence : Zone, IHotZoneSource, IZoneMaximizeWindow, IResizeSource
    {
        ...
        protected DirectionUL _direction;
        ...
        public ZoneSequence(DockingManager manager)
            : base(manager)
        {
            InternalConstruct(VisualStyle.IDE, DirectionUL.Vertical, true);
        }

        public ZoneSequence(DockingManager manager, State state, VisualStyle style, DirectionUL direction, bool zoneMinMax)
            : base(manager, state)
        {
            InternalConstruct(style, direction, zoneMinMax);
        }

        protected void InternalConstruct(VisualStyle style, DirectionUL direction, bool zoneMinMax)
        {
        ...
        protected void RepositionZoneBar(ref Rectangle clientRect)
        {
            ...
            {
                case State.DockLeft:
                    _resizeBar.Direction = DirectionUL.Horizontal;
                    ...
                    break;
                case State.DockTop:
                    _resizeBar.Direction = DirectionUL.Vertical;
