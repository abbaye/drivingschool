...
namespace UtilityLibrary.WinControls
{
	...
	public class CheckBoxEx : CheckBox
    {
		...
		public CheckBoxEx()
		{
			...
			checkMarkChecked = ResourceUtil.LoadBitmapResource(Type.GetType("UtilityLibrary.WinControls.CheckBoxEx"),
				                                "UtilityLibrary.Resources.Controls", "CheckMarkChecked");
			Debug.Assert(checkMarkChecked != null);
			checkMarkUnchecked = ResourceUtil.LoadBitmapResource(Type.GetType("UtilityLibrary.WinControls.CheckBoxEx"),
				                                "UtilityLibrary.Resources.Controls", "CheckMarkUnchecked");
